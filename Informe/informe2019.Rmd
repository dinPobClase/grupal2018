...
cambute_bruto <- cambute_bruto[which(cambute_bruto$longitud.total > 0),]
```
...
El análisis de remoción mostró que Para la zona intermareal de la playa Punta Mala, se estiman 5.72 (S.E= 1.186) individuos por cuadrante, con una probabilidad de detección  de 43 % (S.E= 0.116) (Cuadro \ref{tab:resultados}). 
...
Table: (\#tab:resultados) Estimación de la abundancia y la probabilidad de detección de \textit{Lobatus galeatus} en la zona intermareal de Punta Mala. 
